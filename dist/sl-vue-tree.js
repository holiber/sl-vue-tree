...
/***/ "./node_modules/ts-loader/index.js!./src/sl-vue-tree.ts":
/*!*****************************************************!*\
  !*** ./node_modules/ts-loader!./src/sl-vue-tree.ts ***!
  \*****************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = (vue__WEBPACK_IMPORTED_MODULE_1__["default"].extend({
    ...
    data: function () {
        var path = this.path || [];
        return {
            svtTree: path.length === 0 ? new _tree__WEBPACK_IMPORTED_MODULE_0__["SvtTree"](this.value) : null
        };
    },
    computed: {
        level: function () {
...
var render = function() {
  ...
  return _c(
    "div",
    {
      ...
      class: { "sl-vue-tree-root": _vm.level === 0 }
    },
    [
      _c(
        "div",
          ...
          return _c(
            ...
            [
              ...
              node.children && node.children.length && node.isExpanded
                ? _c("sl-vue-tree", {
                    attrs: { path: node.path.concat(nodeInd) },
                    on: {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _ts_loader_sl_vue_tree_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !ts-loader!./sl-vue-tree.ts */ "./node_modules/ts-loader/index.js!./src/sl-vue-tree.ts");
...
var Component = Object(_node_modules_vue_loader_lib_runtime_component_normalizer__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _ts_loader_sl_vue_tree_ts__WEBPACK_IMPORTED_MODULE_0__["default"],
...
/*!*********************!*\
  !*** ./src/tree.ts ***!
  \*********************/
/*! exports provided: SvtNode, SvtTree */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SvtNode", function() { return SvtNode; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SvtTree", function() { return SvtTree; });
...
var SvtNode = (function () {
    function SvtNode(tree, nodeModel, ind, parent) {
        this.children = [];
        this.tree = tree;
        this.ind = ind;
        this.parent = parent;
        ...
        var isLeaf = nodeModel.isLeaf == void 0 ? false : !!nodeModel.isLeaf;
        var isVisible = !this.parent || (isExpanded && this.parent.isVisible);
        var isFirstChild = this.ind == 0;
        var isLastChild = this.parent ? ind === this.parent.children.length - 1 : this.tree.nodes.length - 1;
        var level = this.parent ? this.parent.level + 1 : 0;
        var path = this.parent ? this.parent.path.concat(this.ind) : [this.ind];
        var pathStr = JSON.stringify(path);
        var childrenModels = nodeModel.children || [];
        delete nodeModel.children;
        Object.assign(this, __assign({}, nodeModel, { isLeaf: isLeaf,
            ...
            path: path,
            pathStr: pathStr }));
        for (var ci = 0; ci < childrenModels.length; ci++) {
            var childModel = childrenModels[ci];
...
var SvtTree = (function () {
    function SvtTree(nodeModels) {
        this.nodes = [];
        this.cursor = null;
        nodeModels = SvtTree.copy(nodeModels);
        this.updateModels(nodeModels);
    }
    SvtTree.copy = function (entity) {
        return JSON.parse(JSON.stringify(entity));
    };
    SvtTree.prototype.updateModels = function (nodeModels) {
        var _this = this;
        this.nodes = nodeModels.map(function (nodeModel, ind) { return new SvtNode(_this, nodeModel, ind); });
    };
    SvtTree.prototype.getNodes = function (path) {
        if (!path || !path.length)
            return this.nodes;
    ...
    SvtTree.prototype.getNode = function (path) {
        var nodes = this.nodes;
        var node;
        for (var _i = 0, path_1 = path; _i < path_1.length; _i++) {
            var nodeInd = path_1[_i];
            if (!nodes)
                return null;
            node = nodes[nodeInd];
            if (!node)
