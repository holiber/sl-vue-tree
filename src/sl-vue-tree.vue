...
<div
  class="sl-vue-tree"
  :class="{'sl-vue-tree-root': level === 0 }"
  ...
  <div ref="nodes" class="sl-vue-tree-nodes-list">
    ...
    >
      <!--<div-->
        ...
        <!--:style="{ visibility:-->
          <!--cursor &&-->
          <!--cursor.node.pathStr === node.pathStr &&-->
          <!--cursor.placement === 'before' ?-->
           <!--'visible' :-->
           <!--'hidden'-->
         <!--}"-->
      <!--&gt;-->
      ...
      <div
        ...
        :path="node.pathStr"
      >
        <div class="sl-vue-tree-gap" v-for="n in level"></div>
      ...
      <!--&gt;-->
        <!--<div-->
          ...
          <!--:style="{ visibility:-->
           ...
           <!--}"-->
        <!--&gt;-->
          <!--&lt;!&ndash; suggested place for node insertion  &ndash;&gt;-->
        <!--</div>-->
...
<script src="./sl-vue-tree.ts" lang="ts"></script>
